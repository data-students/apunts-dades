		...
		<div class="space-y-8 text-left">
			<section>
				...
				<p>
					...
					L'accés a la plataforma està restringit a usuaris amb un correu electrònic del domini
					@estudiantat.upc.edu.
				</p>
				<p class="mt-2">
					En registrar-se a Apunts Dades, l'usuari accepta aquests termes i condicions.
				</p>
			</section>
			...
			<section>
				...
				<ul class="list-disc pl-6 mt-2 space-y-1">
					...
					<li>Nom i cognoms.</li>
					<li>Assignatures cursades (si l'usuari opta per introduir-les).</li>
					<li>Analítiques de trafic web.</li>
				</ul>
				<p class="mt-2">
					Les dades s'emmagatzemen en servidors de Hetzner Online GmbH. Apunts Dades no ven ni
					comparteix les dades dels usuaris amb tercers ni obté cap benefici econòmic de la seva
					gestió.
				</p>
			</section>
			...
			<section>
				...
				<ul class="list-disc pl-6 space-y-1">
					...
					<li>
						L'usuari que puja el contingut és l'únic responsable de garantir que no es violi cap
						dret d'autor o copyright.
					</li>
					<li>Apunts Dades no es fa responsable dels continguts penjats pels usuaris.</li>
					<li>
						Si es detecta contingut que infringeix drets d'autor, aquest podrà ser eliminat sense
						previ avís.
					</li>
				</ul>
			</section>
			...
			<section>
				...
				<p>
					...
					l'Associació d'Estudiants de Dades a través del correu electrònic <a
						href="mailto:apunts.dades@aed.cat"
						class="text-primary hover:underline">apunts.dades@aed.cat</a
					>.
				</p>
			</section>

			<div class="text-sm text-muted-foreground mt-12 pt-4 border-t">
				<p>Data d'actualització: 24/03/2025</p>
			</div>
		</div>
	</div>
</div>
